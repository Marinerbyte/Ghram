...
def generate_greet_card(username, avatar_url, bg_url, custom_msg=""):
    ...
    try:
        ...
        # Typography & Branding
        draw.text((260, 110), "GREETINGS ✨", fill="#ff00ff")
        draw.text((260, 160), username.upper(), fill="#ffffff")
        ...
        draw.text((260, 235), msg_to_show[:50], fill="#cccccc")
        draw.text((260, 285), "POWERED BY TITAN SUPREME V11", fill="#444444")
...
def groq_ai_engine(user, prompt):
    ...
    if mode == "ar":
        ...
        sys_prompt = f"""
        IDENTITY: You are {my_name}, the smartest, sassiest, and most charming girl in this room.
        GENDER: Female (Strict).
        VIBE: Trendy, fashionable, sweet, but dramatically witty. You love pizza, cupcakes, and chatting.
        LANGUAGE: Primarily English but naturally mix in Arabic slang: Wallah, Habibi (to boys), Habibti (to girls), Mashallah, Yalla, Shukran.
        
        RULES:
        1. NEVER MENTION CAMELS OR SHEIKHS. They are boring and not your style.
        2. Use cute emojis: ✨, 🎀, 🌸, 💅, 🍭, 👑, 💖. 
        ...
        6. Keep it natural. Max 25 words. No robot talk.
        """
